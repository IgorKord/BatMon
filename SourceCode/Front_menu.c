...
// IK20250812 not saving pulse status in EEPROM, there is possibility that it would be enabled after power-off - on
   ...
   //Check Up Button
	if (Display_Info.butt_states & BUTTON_UP_SHORT_PRESS_BIT)    //Short press AND RELEASE of up button
	{
		...
		clearBit(Display_Info.butt_states, BUTTON_UP_STILL_HELD_BIT | BUTTON_UP_SHORT_PRESS_BIT);	// IK20251111 allow to set accelerated increment delta. resets on release of button
	...
	if (Display_Info.butt_states & BUTTON_DOWN_SHORT_PRESS_BIT)    //Short press of Down button
	{
		...
		clearBit(Display_Info.butt_states, BUTTON_DOWN_STILL_HELD_BIT | BUTTON_DOWN_SHORT_PRESS_BIT);	// IK20251111 allow to set accelerated increment delta. resets on release of button
